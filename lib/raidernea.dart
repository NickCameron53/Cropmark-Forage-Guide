...
_makingWebCall() async {
  const url =
      'https://www.cropmarkseeds.com/Forage-Products-from-Cropmark-Seeds/Raider-Perennial-Ryegrass';
...
class raidernea extends StatelessWidget {
  @override
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "A new and very persistent diploid variety with increased tiller density and very high DM yields. Highly ranked for persistence.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "Medium to Late (+76 days from 1st September). Relative to Nui = +18 days. High Quality with low aftermath heading and high Metabolisable energy.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "NEA2. Produces animal safe Peramine, very low Lolitrem B, low-medium Ergovaline for broad spectrum insect control while maintaining livestock performance.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('seek more on Raider'),
