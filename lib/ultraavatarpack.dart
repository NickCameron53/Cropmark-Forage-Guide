...
class ultraavatarpack extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
          title: Text('Ultra/Avatar Pasture Pack'),
          centerTitle: true,
      ...
      body: Center(
        child: ListView(
          ...
          children: <Widget>[
            Image.asset('assets/ultraavatarpack.png'),
            Container(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 12.0, 2.0),
              child: RichText(
                text: TextSpan(
                  text: "BEST OF BOTH WORLDS - TETRAPLOID & DIPLOID PASTURE PACK",
                  style: TextStyle(
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                  "The mix of high quality, yield and persistence.\n\nSuitable for dairy or dry stock farming systems.\n\nBest suited to irrigated or mildly 'summer-safe' areas where insect pressure is low to moderate."
                  ,
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                  "AR1 & NEA. Produces animal safe Peramine, very low Lolitrem B, low-medium Ergovaline for broad spectrum insect control while maintaining livestock performance.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
