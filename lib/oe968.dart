...
class oe968 extends StatelessWidget {
  @override
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                  "A newly bred monogerm, medium dry matter, large red tankard bulb cultivar that sits +/- 50% above the ground. It has very good disease and bolting tolerance which maintains quality throughout the crop. Strong foliar growth producing large tops make OE968 suitable for grazing in situ with sheep, cattle or deer.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              child: Image.asset('assets/oe968pic.png'),
            ),
            Container(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 12.0, 2.0),
              child: RichText(
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text: "Suitable for grazing in-situ by all stock classes.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
