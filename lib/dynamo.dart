          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                  "A newly bred monogerm, low dry matter, large red tankard bulb cultivar that sits +/- 60% above the ground. It has very good disease and bolting tolerance which maintains quality throughout the crop. Dynamo has a soft fleshed bulb sitting well above the ground making it suitable for grazing in situ with sheep, cattle or deer and especially younger stock.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              child: Image.asset('assets/dynamopic.png'),
            ),
            Container(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 12.0, 2.0),
              child: RichText(
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text: "Suitable for grazing in situ.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('seek more on Dynamo'),
