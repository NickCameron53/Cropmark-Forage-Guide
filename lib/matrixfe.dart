...
class matrixfe extends StatelessWidget {
  @override
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "A very dense, general-purpose cultivar with strong persistence and very good overall disease resistance particularly to rusts and net blotch. Matrix is an inter-species cross of perennial ryegrass and meadow fescue bringing high annual yields and metabolisable energy values. Matrix SE is the highest ranked standard endophyte containing cultivar in the DairyNZ FVI. Matrix SE is an excellent choice for paddocks suffering from insect damage.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "Standard Endophyte (Feral). Produces animal safe alkaloid Peramine. Lolitrem B and Ergovaline alkaloids are also produced.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
