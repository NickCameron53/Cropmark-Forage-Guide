...
_makingWebCall() async {
  const url =
      'https://www.cropmarkseeds.com/Forage-Products-from-Cropmark-Seeds/Betimo-Fodder-Beet';
...
class betimo extends StatelessWidget {
  @override
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "A newly bred monogerm, medium dry matter, large red tankard bulb cultivar that sits +/- 45% above the ground. It has very good disease and bolting tolerance which maintains quality throughout the crop. Strong foliar growth producing large tops make Betimo suitable for grazing in situ with sheep, cattle or deer; as well as for lifting and may be fed whole or chopped.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              child: Image.asset('assets/betimopic.png'),
            ),
            Container(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 12.0, 2.0),
              child: RichText(
            ...
            Container(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('seek more on Betimo'),
