...
class ultraar1 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        child: ListView(
          ...
          children: <Widget>[
            Image.asset('assets/ultraar1.png'),
            Container(
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "A highly palatable inter-species cross of perennial ryegrass x meadow fescue bringing great annual yields. A very dense, general purpose cultivar with strong autumn and winter activity. Very good overall disease resistance, particularly to rusts and net blotch. Good tolerance to root pulling.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "Late (+78 days from 1st September). Relative to Nui = +20 days. High Quality with low aftermath heading and high Metabolisable energy",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text: "AR1. Produces the animal safe alkaloid Peramine",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              child: Image.asset('assets/ar1insect.png'),
            ),
            Container(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 12.0, 2.0),
              child: RichText(
