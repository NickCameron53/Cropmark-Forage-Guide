          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "A new tetraploid annual (Westerwolds type) cultivar with very large upright leafy tillers. Bullet displays superior establishment speed, very strong autumn, winter and early spring growth with very high pasture quality and palatability.  Has low seed dormancy and fits well between crop cycles.  Survives longer into summer than traditional Westerwolds types.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              child: Image.asset('assets/bulletdata.png'),
            ),
            Container(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 12.0, 2.0),
              child: RichText(
            ...
            Container(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('seek more on Bullet'),
