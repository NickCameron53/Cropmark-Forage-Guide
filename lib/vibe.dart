          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "Vibe Italian ryegrass is a very persistent and very high yielding diploid Italian ryegrass, having been developed as part of a 15 year plant breeding programme focused on developing more persistent Italian ryegrasses. Bounces back from hard grazings well.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              child: Image.asset('assets/vibedata.png'),
            ),
            Container(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 12.0, 2.0),
              child: RichText(
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "Late to very late (+84 days from 1st September). Relative to Nui +26 days. High Quality and high Metabolisable energy",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
