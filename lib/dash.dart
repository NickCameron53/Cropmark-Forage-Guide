      ...
      body: Center(
        child: ListView(
          ...
          children: <Widget>[
            ...
            Container(
              child: Image.asset('assets/dashdata.png'),
            ),
            Container(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 12.0, 2.0),
              child: RichText(
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "Late (+83 days from 1st September). Relative to Nui +25 days. High Quality and high Metabolisable energy",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
