...
class barrieru2 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        child: ListView(
          ...
          children: <Widget>[
            Image.asset('assets/barrieru2.png'),
            Container(
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "A persistent perennial inter-species cross. Broad insect resistance above and below ground. Highly palatable to livestock and will not cause grass staggers or heat stress. Barrier should not be sown with other grass species which are not fully insect tolerant as this will attract unwanted insect activity.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              child: Image.asset('assets/barrierdata.png'),
            ),
            Container(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 12.0, 2.0),
              child: RichText(
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "U2. Produces animal safe Loline while providing above and below low ground broad spectrum insect control",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text: "Black Beetle larvae: very good.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text: "Porina caterpillar: moderate.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              child: Image.asset('assets/u2insect.png'),
            ),
            Container(
              padding: EdgeInsets.fromLTRB(10.0, 20.0, 12.0, 2.0),
              child: RichText(
            ...
            Container(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('seek more on Barrier'),
