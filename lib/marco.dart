          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text:
                      "Marco is a newer tetraploid cultivar with a large seed. Sowing rates should be increased compared to diploid varieties.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text: "Days from sowing to grazing: 55 to 65.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  text: "Club Root Resistance: good.",
                  style: TextStyle(
                    color: Colors.black,
                    fontSize: 15,
                  ),
